...
public struct ToolMetadata {
    ...
    public Func<ToolParameters, ValueTask<ToolResponse>>? ParentPointer { get; init; } = null;
    ...
    public ToolMetadata(
        ...
        string description, 
        bool isChild,
        Func<ToolParameters, ValueTask<ToolResponse>> parentPointer,
    ...
    public async Task<ToolResponse> CallTool(ToolParameters input) =>
